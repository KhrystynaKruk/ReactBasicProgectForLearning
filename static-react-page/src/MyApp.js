...
export function Footer () {
  return (
    <footer className={'footer'}>
      <small>© 2024 development. All rights reserved.</small>
    </footer>
  )
}
